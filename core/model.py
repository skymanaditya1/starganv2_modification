...
class Generator(nn.Module):
    ...
    # Takes an image x and style vector s as input 
    # and translates the image x using the style vector s
    def forward(self, x, s, masks=None):
        # x is the set of images of dimension - N x 3 x 256 x 256 
        # s is the style vector that needs to be applied to these N images
        x = self.from_rgb(x)
        cache = {}
